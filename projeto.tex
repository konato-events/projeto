...
Para o escopo deste TCC, a seção seguinte (\ref{sec:requisitos:mvp}) indica quais destes requisitos serão apresentados.
...
%todo sumarizar aqui todas as funcionalidades citadas acima que serão implementadas a tempo
