...
\documentclass[12pt,a4paper,twoside,hyphens,brazil]{abntex2}
...
%%%%% Bibiografia
\usepackage[num,abnt-full-initials=yes,abnt-repeated-author-omit=yes]{abntex2cite}
...
\subsection{Backend}
Considerando o estilo tradicional da aplicação -- que pode ser citada como um diretório de busca e rede social -- e a experiência do autor, foi decidido utilizar PHP como linguagem principal de desenvolvimento. A outra opção cogitada foi criar uma aplicação JS (também conhecidas como \emph{Single-page app / SPA}), mas o tempo que seria despendido com o aprendizado desse tipo de tecnologia ainda em processo de maturação seria desnecessário, visto que a natureza do sistema não exige alto nível de interatividade.

O framework escolhido foi o Laravel, que %todo finalizar
