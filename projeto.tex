...
%todo: qual a diferença disso pra descriç~ao do mercado? Lá em cima precisamos subdividir o mercado para calcular seu tamanho, mas como fazer isso sem descrever os segmentos de consumidores?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Principais empresas que representam concorrência}
