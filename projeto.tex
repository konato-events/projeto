...
\begin{itemize}
	...
	\item Os seguintes padrões de dados foram utilizados:
		\begin{itemize}
			...
			\item Para campos que receberão valores booleanos, o tipo \texttt{BOOL} deve ser usado em favor de \emph{SMALLINT} -- vale lembrar que \texttt{TINYINT} é uma extensão do SQL-ANSI usada em outros SGBDs;
