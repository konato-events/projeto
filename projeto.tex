...
\FloatBarrier
\subsection{Modelo Conceitual de Classes}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Manual do Usuário} \label{apend:usuario}
