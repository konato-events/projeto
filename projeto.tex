...
%todo: inserir aqui a imagem do último lean canvas
...
\begin{description}[itemsep=-1ex]
	...
	\item[Mercado-alvo inicial] eventos de tecnologia open source; eventos científicos de origem universitária.
\end{description}
...
% detalhar em subseções cada um dos nove pontos do BMC, mesmo assim, além dos pontos extras do Lean Canvas



% Detalhes sobre os canais de divulgação >
