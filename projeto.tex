...
%todo: precisamos explicar porque fazer dois canvas (um de usuario e outro de cliente), conforme o documento de spec do Lean Canvas
...
% Falar que aparentemente só eventos de TI tem aplicativos, sobre a precariedade, sobre as informacoes fornecidas, citar exemplos, etc
