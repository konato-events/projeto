...
\subsection{Bloco Zero: Tamanho do mercado}
...
\subsection{O Problema \emph{(Lean Canvas)}}
% hipotese final: top 3 problems

\subsection{Segmentos de consumidores}
...
\subsection{Proposta de valor} % O produto, benefícios e MVP
% Hipotese final: single, clear and compeling message that states why your product is different and worth buying

\subsection{A Solução \emph{(Lean Canvas)}}

\subsection{Canais de distribuição}
...
\subsection{Relacionamento com o consumidor}

\subsection{Recursos-chave}

\subsection{Parceiros-chave}

\subsection{Principais métricas \emph{(Lean Canvas)}}

\subsection{Atividades-chave} % Hipóteses de mercado e diferenças competitivas

\subsection{Vantagem de mercado \emph{(Lean Canvas)}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Aplicativos de eventos atuais}
...
\section{Concorrência no mercado de Divulgação de Eventos}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Concorrência no mercado de Gerenciamento de Eventos}
...
\section{Concorrência no mercado de Venda de Ingressos}
