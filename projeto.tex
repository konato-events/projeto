...
\subsubsection*{Os tipos de eventos científicos e tecnológicos} \label{sec:eventos}
De acordo com as atividades de transmissão e e criação de conhecimento, conforme citadas acima, há algumas dinâmicas distintas de eventos, que possuem objetivos um pouco distintos e trabalham em torno destes. Os tipos mais comuns de eventos são\cite{tipos-manager}\cite{tipos-parlante}\cite{dicionario}:
