...
% Acredito que aqui vai ser preciso falar das pesquisas que vamos rodar pra avaliar todas as hipoteses, e quais sao elas e como as pesquisas ajudariam a valida-las
...
\begin{itemize}
	...
	\item Informações detalhadas sobre os slots, como:
		\begin{itemize}
			...
			\item dados de contato do(s) palestrante(s) / responsável(is) (opcionais);
	...
	\item Notificações sobre lançamento das grades ou modificações nas mesmas;
\end{itemize}
...
\begin{itemize}
	...
	\item Indicação de locais nos arredores para:
		...
		\end{itemize}
	\item Informações e alertas sobre o início da venda de ingressos e as datas de mudanças de lotes. O usuário deve ser avisado, por exemplo, quando faltarem determinados dias para a troca de lote;
