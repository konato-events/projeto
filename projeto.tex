...
Seguem aqui alguns componentes que podem ser utilizados de inspiração, e algumas sugestões já pensadas para o nome do sistema. Tais ideias também foram lançadas num aplicativo web chamado NameStorm (http://namestorm.niicho.com/3aca9), que facilita encontrar domínios e perfis sociais com os nomes indicados, bem como angariar votos para decidir a preferência da equipe.\\
